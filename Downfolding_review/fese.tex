...
\end{align*}\HHZ{Change $n^{i, \uparrow} \to n_{i, \uparrow}$ to be consistent with Eq. (16)?}
...
The fact that the Hund coupling is chosen first \HHZ{I guess you want to say Hund coupling is identified as the most important descriptor by MP. ``Chosen" sounds like we choose it manually.} is consistent with the several studies in the literature, which find a prominent Hund coupling can explain some of the properties of bulk FeSe.~\cite{demedici_hunds_2011,de_medici_janus-faced_2011,georges_strong_2013,busemeyer_competing_2016}.
