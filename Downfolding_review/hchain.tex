...
\caption{\HJC{Put model vs ab-initio plots here. Done -Kiel} DMC energy vs. model energy for the H$_{10}$ chain at 1.5 \AA \:(left) and 2.5 \AA \:(right). The RMS devision between the DMC and $U$-$t$ model energies at $2.5$ \AA \:interatomic separation is reduced to less than 0.05 eV/atom. \HHZ{Adjust xlim and ylim of the second figure?}}\label{fig:fit_quality}
\end{figure}
