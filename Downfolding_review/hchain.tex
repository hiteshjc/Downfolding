...
are evaluated is obtained by generating intrinsic atomic orbitals (IAO)\BDB{Need citaton?} from the Kohn-Sham orbitals 
...
\HHZ{Check whether you mislabelled x and y. Normally, $E[\Psi]$ means the ab-initio energy whereas $E_{eff}[\Psi]$ means the model energy. We usually put ab-initio energy to the x-axis. }
  \BDB{why is the energy scale larger than the spread of the data?} 
