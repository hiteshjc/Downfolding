...
We now move on to one of the simplest extended \emph{ab-initio} systems, a hydrogen chain in one dimension with periodic boundary conditions, which has been used as a test model for cross-checks and validation of a variety of modern \textit{ab-initio} many-body methods \cite{Motta_Simons}. 
