...
\caption{\HJC{Put model vs ab-initio plots here. Done -Kiel} DMC energy vs. model energy for the H$_{10}$ chain at 1.5 \AA \:(left) and 2.25 \AA \:(right). Note that the energy range narrows significantly for larger interatomic separation. \HHZ{Adjust xlim and ylim of the second figure?}}\label{fig:fit_quality}
\end{figure}
