...
orthogonalized using the L\"owdin procedure. The resulting orbitals are shown in Fig.~\ref{fig:h10orb} \HHZ{Could you plot these orbitals 
...
\includegraphics[scale=0.5]{{./Figures/H_chain_fit_model_length2.5_tUs}.pdf}
\caption{\HJC{Put model vs ab-initio plots here. Done -Kiel} DMC energy vs. model energy for the H$_{10}$ chain at 1.5 \AA \:(left) and 2.5 \AA \:(right). The RMS devision between the DMC and $U$-$t$ model energies at $2.5$ \AA \:interatomic separation is reduced to less than 0.05 eV/atom. }\label{fig:fit_quality}
\end{figure}
