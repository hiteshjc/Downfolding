...
orthogonalized using the L\"owdin procedure. The resulting orbitals are shown in Figure~\ref{fig:h10orb}. These are the orbitals that enter the 1-band Hubbard Hamiltonian. 
