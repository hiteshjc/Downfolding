...
\begin{figure}
\centering
\includegraphics[scale=0.5]{{./Figures/H_chain_fit_model_length1.5_tUs_inset}.eps}
\includegraphics[scale=0.5]{{./Figures/H_chain_fit_model_length2.25_tUs_inset}.eps}
\includegraphics[scale=0.5]{{./Figures/r2_ut_vs_separation_h_chain.eps}}
