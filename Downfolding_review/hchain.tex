...
effectiveness of the one-band Hubbard model, as seen in Fig.~\ref{fig:fit_quality}(C). The insets show the intrinsic atomic orbitals for which we calculated the RDMs (descriptors).  \lucas{What is the conclusion of this paragraph?}
