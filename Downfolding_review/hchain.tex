...
and exchange interactions also become important for $r<r_c$ \cite{ZhengThesis}. The a kink appeared near $r_c$ in the R$^2$ plot [Figure~\ref{fig:fit_quality}(c)] is a manifestation of underlying metal-to-insulator transition in the \textit{ab-intio} system. 
