...
Graphene has drawn much attention in the last decade because of its unusual electronic and structural properties and its potential applications in electronics~\cite{Wallace1947, Novoselov2004,NovoselovNature2005, Katsnelson2006, Geim2007, Novoselov2007, Castro2009}. 
...
\begin{figure*}[hbt]
 ...
 % \subfigure[]{\includegraphics[clip, width=0.30\textwidth]{c_sigma.png}}
    \subfigure[]{\includegraphics[clip, width=0.30\textwidth]{./Figures/c_pi.png}}
    \subfigure[]{\includegraphics[clip, width=0.30\textwidth]{./Figures/h_wan.png}}
