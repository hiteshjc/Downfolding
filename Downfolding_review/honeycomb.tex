...
which is consistent with both systems being semimetals. The Fermi velocity of graphene could be estimated from the dowfolded parameters [$t=3.62(1)$ eV and $U=7.21(4)$ eV] using Hartree-Fock approximation. \HJC{Why say "could be" when you have already estimated it. Also you just do mean field on U term and renormalize the t to get vf?} 
This gives rise to \HJC{a Fermi velocity of?} $1.2\times 10^{6}$ m/s, which is consistent with the experimental value $1.1 \times 10^6$ m/s~\cite{Siegel2011}. 
