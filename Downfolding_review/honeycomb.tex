...
are performed on a $3\times3$ cell (32 carbons) and the energy and RDMs evaluated with VMC. 
(We expect further renormalizations in corresponding DMC calculations~\cite{Changlani2015}, 
...
root mean square error of the predicted energies (Fig.~\ref{fig:ne_aidmd_gh}). The ratio of $U/t$ is smaller 
