...
In particular, identification of `strongly correlated' materials as materials where band theory is not an accurate representation of the systems \HJC{system?} is a statement about effective Hamiltonians.
...
\HJC {The next sentence is long and repeating an idea twice in the same line}
...
\HJC{Proposed: The effective one particle hoppings are obtained from standard DFT calculations by projecting the Kohn Sham bands onto localized Wannier functions~\cite{Pavirini}.} 
