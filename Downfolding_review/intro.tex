...
While they have many advantages, all of these methods suffer from a lack of internal checks on the quality of the resultant model--it is typically not possible to know if a given model {\it ansatz} was a good guess or not. \lucas{Check this..} 
