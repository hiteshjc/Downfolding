...
The interactions are then estimated based on certain model of screening of the Coulomb interactions (e.g., constrained DFT and random phase approximations). 
