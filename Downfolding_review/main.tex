...
Here we discuss an approach that democratically treats 
the kinetic and potential parts of the Hamiltonian and one that provides a transparent way 
...
We emphasize that estimating the effective Hamiltonian reliably is crucial for 
...
\subsection{Three-band Hubbard model to one band Hubbard model at half filling - \HJC{STILL EDITING, PLEASE IGNORE}}
