...
The values of most parameters are highly correlated with one another this is not an easy task. 
...
There are other downfolding approaches that include traditional Lowdin downfolding 
within a stochastic approach and the related method of canonical transformations, also being actively pursued 
as a full fledged quantum chemistry method. These share the same aims as us, in the sense that they work with 
...
what is missing and how it could be possibly rectified. It is also possibly best suited for extended systems (solids) where 
there is often a clear separation of energy scales associated with the single particle 
