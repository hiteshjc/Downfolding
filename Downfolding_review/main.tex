...
\def\firstAuthorLast{Hitesh J. Changlani et al} %use et al only if is more than 1 author
...
\def\Address{$^{1}$Department of Physics and Astronomy, Johns Hopkins University, Baltimore, Maryland 21218, USA \\
$^{2}$Argonne Leadership Computing Facility, Argonne National Laboratory, 9700 South Cass Avenue, Lemont, 60439, Illinois, USA\\
...
>>>>>>> e61c5335c049d05855f550a1e33cd79f32d385db
