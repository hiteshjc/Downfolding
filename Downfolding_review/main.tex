...
most prominently the constrained-RPA approach. The kinetic part is obtained from a standard 
...
The viewpoint we take here is to work with many body wavefunctions of \emph{ab initio} systems, 
...
knowledge of exact eigenstates - rather we "learn" the effective Hamiltonian from a database 
of low energy wavefunctions and their associated energies (expectation value of the effective Hamiltonian). 
...
The QMC method works directly in the continuum and explicitly introduces correlation (via Jastrow factors) 
...
a many electron problem to a few electron problem. Information from many-body wavefunctions detects 
