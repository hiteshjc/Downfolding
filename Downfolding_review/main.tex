...
approach and work with Hubbard or Kanamori Hamiltonians involving only the low energy electrons. 
...
near the Fermi level, screened interactions depend on states even \textit{far} away from it, leading to Hubbard U's 
