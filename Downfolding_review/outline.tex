...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Simple example of lattice to lattice downfolding, Explain model and parameter set \HJC{In response to LKW: Not worried about whether parameters correspond to cuprate or not... This is to explain downfolding, not solve the final cuprate problem}
	\end{itemize}
