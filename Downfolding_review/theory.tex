...
\begin{definition}
Let ${\mathcal H}$ be a Hilbert space. Then ${\mathcal LE}(H,N)$ is a subset of ${\mathcal H}$ spanned by $N$ vectors given by the lowest energy solutions to $H\ket{\Phi_i}=E_i{\Phi_i}$. 
\end{definition}

\begin{definition}
$H_{eff}$ is an operator on the Hilbert space ${\mathcal LE(H,N)}$.	\lucas{Does this need to be linear?} 
\end{definition}
