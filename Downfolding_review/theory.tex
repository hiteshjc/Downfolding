...
In short, Theorem 2 does not work (in fact the) because when we apply H to psi (belong to LE), it in general will generate HE components. This is the same concern that Hitesh expressed in his comment. 
}
