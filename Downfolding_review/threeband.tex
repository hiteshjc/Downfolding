...
Till this point, all our results focused 
We note that one could construct 
a different model (with say an additional next nearest neighbor $t'$) that does not exhibit an energy dependence 
and describes all six states  
\begin{figure}[]
\centering
