...
\centering
 \leavevmode\rlap{\usebox1}% Print image
  \rlap{\hspace*{-5pt}\vspace*{100pt}\raisebox{\dimexpr\ht1--3.0\baselineskip}{(A)}}% Print label
  \phantom{\usebox1}
...
\subfigimg[width=0.485\linewidth]{(B)}{./Figures/Predict_8site_Ep_3.eps}
\subfigimg[width=0.485\linewidth]{(C)}{./Figures/Predict_8site_Ep_5.eps}
\end{minipage}
