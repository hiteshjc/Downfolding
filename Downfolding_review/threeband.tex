...
\right)\,,
\end{eqnarray}
\lucas{Can we not put this in the supplementary?}
\HJC{good idea... looking into an "appendix"}
...
\HJC{Need to look into this para as suggested by lucas and decide what goes in appendix and what stays}
...
with a linear grid spacing of $0.002$; yielding $\alpha_1=0.216$, $\alpha_2=0.042$, $\alpha_3=0.018$ and $\alpha_4=0.016$. \lucas{what insight does knowing these alphas give? If it's how much d and p character I don't think anyone will know what they mean; I certainly don't. I think most of this paragraph can be supplementary or appendix.}
...
We performed DMD with the same three low-energy states, using their energies and 
...
similar outcomes.
For our test example, we find $U/t = 13.45 $ and $t = 0.3025 $ eV, 
...
The one-band $U/t$ values were obtained by comparing $\langle d_1^{\dagger} d_2\rangle$ 
...
Now we perform checks on the accuracy of the downfolded model. 
...
The lowest energy gap error is within $0.0004$ eV (1\% relative error). 
...
\HJC{Deleted the line that was problematic because we made that point anyway in the last para}
