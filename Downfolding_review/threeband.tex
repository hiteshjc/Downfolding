...
and next-nearest neighbor coppers ($\alpha_4$) as shown in Fig.~\ref{fig:threeband}. 
The explicit form of ${\bf T}$ after accounting for the symmetries of the 
lattice has been shown in the Appendix. These parameters are optimized to minimize a certain cost function, 
