...
\renewcommand{\subfigimg}[3][,]{%
  ...
  \rlap{\hspace*{45pt}\vspace*{12pt}\raisebox{\dimexpr\ht1-10\baselineskip}{#2}}% Print label
  \phantom{\usebox1}
}
\begin{figure}
\centering
 \begin{tabular}{@{}p{0.90\linewidth}@{\quad}p{\linewidth}@{}}
\subfigimg[width=0.45\linewidth]{(A)}{./Figures/spectrum_vs_ep_Ud_8.eps}
\subfigimg[width=0.49\linewidth]{(B)}{./Figures/U_and_hopping_combined_vs_ep_Ud_8.eps}
\subfigimg[width=0.45\linewidth]{(C)}{./Figures/spectrum_vs_Ud_ep_3.eps}
\subfigimg[width=0.48\linewidth]{(D)}{./Figures/U_and_hopping_combined_vs_Ud_ep_3.eps}
\end{tabular}
...
\renewcommand{\subfigimg}[3][,]{%
  \setbox1=\hbox{\includegraphics[#1]{#3}}% Store image in box
  \leavevmode\rlap{\usebox1}% Print image
  \rlap{\hspace*{45pt}\vspace*{12pt}\raisebox{\dimexpr\ht1-10.5\baselineskip}{#2}}% Print label
  \phantom{\usebox1}
}
\begin{figure}
\centering
 \begin{tabular}{@{}p{0.90\linewidth}@{\quad}p{\linewidth}@{}}
\subfigimg[width=0.49\linewidth]{(A)}{./Figures/lowenergy_1and3_vs_Ud_ep_3.eps}
\subfigimg[width=0.49\linewidth]{(B)}{./Figures/lowenergy_1and3_vs_Ud_ep_5.eps}
\end{tabular}
...
Our results are summarized in Table~\ref{tab:predictivity}. In all cases, 
...
%\HJC{Commented problematic lines because we made that point anyway in the last para}
%This suggests that one could perform DMD on a small size system to obtain the effective model at a low cost. 
%In the spirit of multiscale simulation, one could then solve this effective model within its regime of validity\lucas{What does this mean specifically?} for larger systems at a significantly reduced cost compared to solving the original model or \textit{ab initio} Hamiltonians.
...
case. 
\HJC{Not sure how to fix this... but will look into it}
\lucas{What is this table supposed to show? Is it different from Fig 4?} }
...
\centering
 \begin{tabular}{@{}p{0.90\linewidth}@{\quad}p{\linewidth}@{}}
\subfigimg[width=0.49\linewidth]{(A)}{./Figures/downfolded_params_diffwindows_ep_3.eps}
\subfigimg[width=0.49\linewidth]{(B)}{./Figures/lowenergygaps_diffwindows_ep_3.eps}
\end{tabular}
