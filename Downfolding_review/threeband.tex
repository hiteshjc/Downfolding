...
We focus on the lowest six eigenstates, which in the large $U$ limit correspond to the 4C2 states 
of the effective spin model in its $S_z=0$ sector, all of which correspond to \textit{d like} excitations. 
The eigenstates above this manifold involve \textit{p-like} 
excitations, an aspect the 1-band model is not designed to capture. 

Fig.~\ref{fig:energyfit} shows the comparison of the energy gaps of the downfolded 1-band and full 3-band models. 
