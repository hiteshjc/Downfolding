...
are used in the DMD procedure. This is because the DMD aims to provide the 1-band description 
...
using the lowest three eigenstates vs all the six lowest eigenstates changes $U/t$ from $13.8$ to $9.44$. 
(The attentive reader would have noticed the slightly different estimate of $U/t\approx 13.45$ when 3 states were used for both the DMD and cost minimization. This is because $\tilde{d}$ are slightly different in the two cases). 
