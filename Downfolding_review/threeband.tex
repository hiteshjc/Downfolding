...
To give a concrete and representative example of our results, we start with 1-RDM of the lowest three eigenstates for $U_d/t_{pd}=8$ and $\Delta/t_{pd}=3$; these are $12 \times 12$ matrices. We optimize the transformation according to Eq. and find the optimal parameters $\alpha_1=0.220$,$\alpha_2=0.044$,$\alpha_3=0.020$ and $\alpha_4=0.018$ 
\begin{small}
\begin{eqnarray}
\left(
\begin{array}{cccc}
...
Next, we consider analogous res 
