...
The eigenstates outside of this manifold involve \textit{p-like} excitations which the one-band model is not designed \HHZ{able?} to capture. 
...
satisfied to a relative error within 0.5 percent, verifying \HHZ{confirming?}  
...
The state-matching perspective \HHZ{approach?} was supported by DMD performed 
...
the Hilbert space comprises of 112,911,876 basis states (\HHZ{compared to XXXX }). Roughly 200 Lanczos iterations were carried out, 
