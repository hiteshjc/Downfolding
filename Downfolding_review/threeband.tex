...
We chose the lowest three eigenstates of the three-band model for computing the cost in Eq.~\eqref{eq:C}. 
A brute force scan in the four dimensional space of parameters was performed to optimize ${\bf T}$ 
and the corresponding trace conditions and orthogonality are simultaneously 
